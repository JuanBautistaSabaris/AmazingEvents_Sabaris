...
function arrayPastEvents(events) {
    let pastEvents = [];
...
console.log(arrayPastEvents(events));
...
function cardCreator(eventsArray) {
    ...
    document.getElementById("cardspastevents").appendChild(dFrag);
}
...
cardCreator(arrayPastEvents(events));
visibleCards(arrayPastEvents(events));